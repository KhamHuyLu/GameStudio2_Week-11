...
public class CoinCollector : MonoBehaviour
{
    ...
    public static List<Vector3> collectedCoins = new List<Vector3>();
    ...
    {
        if (collectedCoins.Count < coinDescriptions.Length)
        {
            collectedCoins.Add(transform.position);
            descriptionText.text = coinDescriptions[collectedCoins.Count - 1];
